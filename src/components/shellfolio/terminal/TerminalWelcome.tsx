    ...
    return (
        <div className="mb-6 animate-in fade-in duration-700">
            <div className="mb-4 flex flex-col gap-4 sm:flex-row sm:items-start sm:gap-8">
                <pre className="text-xs sm:text-sm font-bold opacity-90" style={{ color: 'var(--terminal-prompt-user)' }}>
{`
 ___ _        _ _  __            
...
`}
                ...
                <pre className="text-[6px] leading-[7px] sm:text-[7px] sm:leading-[8px] font-bold opacity-90" style={{ color: 'var(--terminal-prompt-user)' }}>
{`
                                                 .....                                              
                                          ..:=++=++++=:..                                           
                                       ...*%%@@@%%@%%%%%#*+:....                                    
