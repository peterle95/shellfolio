...
export default function Home() {
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-black">
      <div className="relative min-h-screen w-full flex items-center justify-center bg-[url('/images/tv-frame.png')] bg-center bg-no-repeat bg-contain">
        <main className="w-[65vw] max-w-7xl h-[70vh] min-h-[500px] flex flex-col md:flex-row gap-8 p-2 sm:p-8 items-center justify-center">
